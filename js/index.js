const releasesData = [
    {
        ver: 'v3.0.1',
        title: 'Исправление ошибки и улучшения',
        text: 'Выпущено срочное обновление для устранения ложных срабатываний защиты от вредоносного кода. Также обновлена страница социальных сетей.',
        date: '01.09.2025'
    },
    {
...
const newsData = [
    {
        title: 'Обновление v3.0.1: Исправление критической ошибки безопасности',
        excerpt: 'Мы выпустили срочное исправление для ошибки, которая приводила к ложному срабатыванию защиты от вредоносного кода...',
        fullText: 'Выпущено обновление v3.0.1, которое исправляет критическую ошибку в модуле `input-sanitizer.js`. Теперь проверка на вредоносный код работает корректно и больше не выдает ложных срабатываний при добавлении ярлыков. Также в этом обновлении мы улучшили страницу социальных сетей, обновив ссылки и дизайн для лучшего взаимодействия с нашим сообществом в Telegram. Мы благодарим наших пользователей за оперативную обратную связь.'
    },
    {
